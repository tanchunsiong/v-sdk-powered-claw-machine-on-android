...
public class SelfShareSubscribeActivity extends AppCompatActivity implements ZoomVideoSDKDelegate {

    private static final String TAG = "SelfShareSubscribeActivity";

    public final static int REQUEST_SELECT_ORIGINAL_PIC = 2003;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_self_share_subscribe);
        initData();
        initView();
    ...
    public static void startActivity(@NonNull Activity activity) {
        Intent intent = new Intent(activity, SelfShareSubscribeActivity.class);
